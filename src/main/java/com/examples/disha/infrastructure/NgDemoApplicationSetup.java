...
import com.examples.disha.web.rest.ResponseCorsFilter;
    ...
    protected Injector getInjector() {
        return Guice.createInjector(new ServletModule() {
            ...
            protected void configureServlets() {
                ...
                // Configuring Jersey via Guice: com.examples.disha.web.rest
                ResourceConfig resourceConfig = new PackagesResourceConfig("com/examples/disha/web");
